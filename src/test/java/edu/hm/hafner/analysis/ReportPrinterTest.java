...
class ReportPrinterTest extends ResourceTest {
    ...
    void testWarningLogJavaUtilLogginAdaptor() {
        ...
        report.add(issue);
        java.util.logging.Logger logger = mock(java.util.logging.Logger.getLogger(JavaUtilLogginAdaptor.class.getName()).getClass());
    ...
    void testWarningLogginSLF4JAdaptor() {
        ...
        Issue issue = new IssueBuilder().setSeverity(Severity.WARNING_HIGH).setMessage("Warning with high importance").build();
        report.add(issue);
        org.slf4j.Logger logger = mock(org.slf4j.LoggerFactory.getLogger(SLF4JAdaptor.class).getClass());
