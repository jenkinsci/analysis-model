...
class ParsersTest extends ResourceTest {
    ...
    @Test
    void shouldFindAllTerraformLintIssues() {
    ...
    /** Runs the Gitleaks parser on an output file that contains 3 issues. */
    @Test
    void shouldFindAllGitleaksIssues() {
    ...
    void shouldFindAllStaticcheckIssues() {
        findIssuesOfTool(4, "staticcheck", "staticcheck-report.json");
    }
    ...
    /** Runs the Gradle Lint parser on an output file that contains 2 issues. */
    @Test
    void shouldFindAllGradleLintIssues() {
        findIssuesOfTool(2, "gradle-lint", "gradle-lint.json");
    }
