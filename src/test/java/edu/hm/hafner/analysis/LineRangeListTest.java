...
class LineRangeListTest {
    ...
    void shouldResizeCorrectly() {
        ...
        for (int i = 0; i < 100; i++) {
            assertThat(list.get(i)).isEqualTo(new LineRangeBuilder()
                    .setStart(i * 2)
                    .setEnd(i * 2 + 1)
                    .build());
            assertThat(list.contains(new LineRangeBuilder()
                    .setStart(i * 2)
                    .setEnd(i * 2 + 1)
                    .build())).isTrue();
        }
    ...
    void shouldProvideContains() {
        ...
        last.remove(new LineRangeBuilder()
                ...
                .setEnd(5)
                .build());
        assertThat(last).containsExactly(new LineRangeBuilder()
                .setStart(0)
                .setEnd(1)
        ...
        middle.remove(new LineRangeBuilder()
                .setStart(2)
                .setEnd(3)
                .build());
        assertThat(middle).containsExactly(new LineRangeBuilder()
                .setStart(0)
                .setEnd(1)
                .build(), new LineRangeBuilder()
                .setStart(4)
    ...
    private LineRangeList createThreeElements() {
        ...
        range.add(new LineRangeBuilder()
                .setStart(0)
                .setEnd(1)
                .build());
        range.add(new LineRangeBuilder()
        ...
        range.add(new LineRangeBuilder()
                ...
                .setEnd(5)
                .build());
        assertThat(range).containsExactly(new LineRangeBuilder()
                .setStart(0)
                .setEnd(1)
                .build(), new LineRangeBuilder()
                    .setStart(2)
