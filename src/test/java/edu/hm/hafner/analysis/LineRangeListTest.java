...
class LineRangeListTest {
    ...
    void shouldRejectDoubleSets() {
        LineRangeBuilder sut = new LineRangeBuilder();
        sut.setStart(0);
        assertThatExceptionOfType(IllegalStateException.class).isThrownBy(() -> sut.setStart(0));

        sut.setEnd(0);
        assertThatExceptionOfType(IllegalStateException.class).isThrownBy(() -> sut.setEnd(0));
    }
