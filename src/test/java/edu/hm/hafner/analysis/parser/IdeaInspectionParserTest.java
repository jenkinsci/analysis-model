    ...
    void issue56235() {
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(iterator.next())
                    ...
                    .hasLineStart(309)
                    .hasLineEnd(309)
                    .hasMessage("The declared exception <code>IOException</code> is never thrown in method implementations")
            ...
            softly.assertThat(iterator.next())
                    ...
                    .hasLineStart(53)
                    .hasLineEnd(53)
                    .hasMessage("Not 'edu.umd.cs.findbugs.annotations.Nullable' but 'org.jetbrains.annotations.Nullable' would be used for code generation.")
            ...
            softly.assertThat(iterator.next())
                    ...
                    .hasLineStart(195)
                    .hasLineEnd(195)
                    .hasMessage("Method invocation <code>getCodeFragment</code> may produce <code>NullPointerException</code>")
                    .hasFileName("$PROJECT_DIR$/src/test/java/edu/hm/hafner/analysis/parser/dry/cpd/CpdParserTest.java");
        });
    }
}
