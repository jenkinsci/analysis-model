...
class IssueDifferenceTest {
    ...
    void shouldCreateIssueDifference() {
        ...
        IssueDifference issueDifference = new IssueDifferenceBuilder().setCurrentIssues(currentIssues).setReferenceIssues(referenceIssues).setReferenceId(CURRENT_BUILD).build();
