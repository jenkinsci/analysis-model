...
class IssueDifferenceTest {
    ...
    void shouldCreateIssueDifference() {
        ...
        IssueDifference issueDifference = createIssueDifference(referenceIssues, currentIssues);
    ...
    private IssueDifference createIssueDifference(final Report referenceIssues, final Report currentIssues) {
