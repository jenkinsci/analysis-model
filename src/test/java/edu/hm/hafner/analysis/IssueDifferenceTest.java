...
class IssueDifferenceTest {
    ...
    private IssueDifference useIssueDifferenceBuilder(final Report currentIssues, final String referenceId,
    ...
    void shouldCreateIssueDifference() {
        ...
        IssueDifference issueDifference = useIssueDifferenceBuilder(currentIssues, CURRENT_BUILD, referenceIssues);
