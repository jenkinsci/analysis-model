...
class IssueDifferenceTest {
    ...
    void shouldCreateIssueDifference() {
        ...
        IssueDifference issueDifference = new IssueDifferenceBuilder()
                .withCurrentIssues(currentIssues)
                .withReferenceId(CURRENT_BUILD)
                .withReferenceIssues(referenceIssues)
                .build();
    ...
    private Issue createIssue(final String message, final String fingerprint) {
        ...
        builder.setFileName("file-name")
                ...
                .setOrigin("origin")
                .setLineRanges(new LineRangeList(singletonList(new LineRangeBuilder().withLineRange(5, 6).build())))
