...
class IssueDifferenceTest {
    ...
    /**
     * Creates a new IssueDifference instance for the tests.
     * @param currentIssues Report with current issues.
     * @param referenceId ID identifying the reference report.
     * @param referenceIssues Reference report with previous issues.
     * @return New IssueDifference instance.
     */
    private IssueDifference createIssueDifference(final Report currentIssues, final String referenceId,
