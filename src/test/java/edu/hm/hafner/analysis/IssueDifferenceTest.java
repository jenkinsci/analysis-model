...
class IssueDifferenceTest {
    ...
    private IssueDifference createIssueDifference(final Report currentIssue, final String build, final Report referenceIssues)    {
        return new IssueDifferenceBuilder()
                .setCurrentIssues(currentIssue)
                .setReferenceReportId(build)
                .setPreviousReport(referenceIssues)
                .build();
