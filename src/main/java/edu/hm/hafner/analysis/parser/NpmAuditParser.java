...
public class NpmAuditParser extends JsonIssueParser {
    ...
    private static final String VULNERABILITY_SEVERITY_MODERATE = "moderate";
    private static final String VULNERABILITY_SEVERITY_HIGH = "high";
    private static final String VULNERABILITY_SEVERITY_CRITICAL = "critical";
    ...
    private String cvssScore(final JSONObject vulnerability) {
        ...
        if (cvss != null) {
            var cvssScore = cvss.optString("score", null);
            if (cvssScore != null) {
                return cvssScore;
            }
        }
    ...
    private Severity mapSeverity(final String severity) {
        return switch (severity) {
            case VULNERABILITY_SEVERITY_MODERATE -> Severity.WARNING_NORMAL;
            case VULNERABILITY_SEVERITY_HIGH -> Severity.WARNING_HIGH;
            case VULNERABILITY_SEVERITY_CRITICAL -> Severity.ERROR;
