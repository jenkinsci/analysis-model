...
public class NullSafeListComp<T> implements List<T> {
    private final List<T> list;

    public NullSafeListComp () {
        list = new ArrayList<>();
    }

    public NullSafeListComp (int size) {
        list = new ArrayList<>(size);
    }

    public NullSafeListComp (Collection<? extends T> col) {
        list = new ArrayList<>();
        addAll(col);
    }
